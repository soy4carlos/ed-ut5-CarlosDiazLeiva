...
public class Suma {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    System.out.println("El resultado de la suma es: " + sumar(num1Suma, num2Suma));
                    break;
                case 2:
                    ...
                    System.out.println("El resultado de la resta es: " + restar(num1Resta, num2Resta));
                    break;
                case 3:
                ...
                case 4:
                    ...
                    System.out.println("El resultado de la división es: " + dividir(dividendo, divisor));
                    break;
                case 5:
                    ...
                    if (numFactorial >= 0) {
                        ...
                        while (numFactorial < 0) {
                            System.out.println("El número no puede ser negativo. Introduce un número válido: ");
                            numFactorial = scanner.nextInt();
                        }
                        System.out.println("El factorial de " + numFactorial + " es: " + factorial(numFactorial));
                    }
    ...
    //Método recursivo para calcular el factorial de un número entero positivo
